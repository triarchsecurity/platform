...
Last activity: 2026-05-04 — Milestone v2.0 started; v1.14.0 archived
...
**Phases:** TBD (roadmap regenerated by /gsd:new-milestone)
**Requirements:** TBD
**Status:** Defining requirements (sourced from .planning/v1.15-MILESTONE-DRAFT.md)
