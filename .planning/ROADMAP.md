...
**Plans:** 6 plans
- [ ] 01.1-01-PLAN.md — api-auth helpers (requireSignedIn / requireStaff / requireMembership) with deprecated requireAdmin alias
- [ ] 01.1-02-PLAN.md — Endpoint classification (CLASSIFICATION.md table covering all 32 endpoints)
...
| 1.1. Membership Enforcement Audit | 0/6 | Planned     | - |
