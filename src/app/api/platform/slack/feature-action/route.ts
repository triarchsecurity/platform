...
import { handleFeatureAction } from '@/lib/slack-actions/feature';
import type { SlackInteractivePayload } from '@/lib/slack-actions';

/**
 * Legacy direct entry point for OttoBot feature-action button clicks.
...
export async function POST(req: NextRequest) {
  ...
  const result = await handleFeatureAction({ payload, action, rawBody: '', ipAddress, userAgent });
